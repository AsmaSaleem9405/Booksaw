...
export const metadata: Metadata = {
  ...
  keywords: 'bookstore, online books, read books, buy books, wildlife literature, programming books',
  openGraph: {
    title: 'BookSaw - Digital Bookstore & Library',
    description: 'Explore curated collections of top books, novels, and educational guides.',
    type: 'website',
